...
export const Slide = (props) => {
  ...
  return (
    ...
    <div
    className={props.slideIndex === props.index + 1 ? "slide active-anim" : "slide"}
    style={stylo}
>
    <div className='slide-content'>
    <img src={`${process.env.PUBLIC_URL}/assets/img/${props.data.image}`} alt='{props.data.title}' width='200px' height='200px'/>
